    ...
    <h3><i class="fas fa-user-graduate mr-2 mt-3"></i>UBAH SISWA</h3><div><hr>
      <div class="modal-body">
          ...
          <input type="hidden" name="id" value="<?= $swa["id"]  ?>">
    				...
    				<input type="text" name="nomor_induk_siswa" class="form-control" id="nomor_induk_siswa" placeholder="" required value="<?= $swa["nomor_induk_siswa"] ?> ">

    				<label for="nama">nama</label>
    				<input type="text" name="nama" class="form-control" id="nama" placeholder="" required value="<?= $swa["nama"] ?> ">

    				<label for="jk">jenis kelamin</label>
    				<input type="text" name="jk" class="form-control" id="jk" placeholder="" required value="<?= $swa["jk"] ?> ">

    				<label for="tempat_tanggal_lahir">tempat tanggal lahir</label>
    				<input type="text" name="tempat_tanggal_lahir" class="form-control" id="tempat_tanggal_lahir" placeholder="" required value="<?= $swa["tempat_tanggal_lahir"]; ?> ">

    				<label for="kelas">kelas</label>
    				<input type="text" name="kelas" class="form-control" id="kelas" placeholder="" required value="<?= $swa["kelas"] ?> ">

    				<label for="jurusan">jurusan</label>
    				<input type="text" name="jurusan" class="form-control" id="jurusan" placeholder="" required value="<?= $swa["jurusan"] ?> ">

            <label for="gambar">gambar</label>
            <input type="text" name="gambar" class="form-control" id="gambar" placeholder="" required value="<?= $swa["gambar"] ?>
             ">
